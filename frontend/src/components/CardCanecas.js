...
export default function CardCanecas({infos}) {
            ...
            <Grid item key={id} xs={12} sm={6} md={4} >
              ...
              <Card>
                  ...
                  <ul>
                    {/* {tier.description.map((line) => ( */}
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                            <strong>Porcelana:</strong>  R$  {valor.val1}
                      </Typography>
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                            <strong>Polimero:</strong>  R$ {valor.val2}
                      </Typography>
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                            <strong>Espelhada:</strong>  R$ {valor.val3}
                      </Typography>
                    {/* ))} */}
                  </ul>
                </CardContent>
                ...
                <Linkar href={`https://api.whatsapp.com/send?phone=5571991604540&text=${nome} || ${descricao} 
                 ||  Valores: Porcelana: R$ ${valor.val1} - Polimero: R$ ${valor.val2} - Especiais: R$ ${valor.val3} !`} 
