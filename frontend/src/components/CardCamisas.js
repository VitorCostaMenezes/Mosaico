...
export default function CardCamisas({infos}) {
            ...
            <Grid item key={id} xs={12} sm={6} md={4} >
              ...
              <Card>
                  ...
                  <ul>
                    {/* {tier.description.map((line) => ( */}
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                            <strong>Algodão:</strong>  R$  {valor.val1}
                      </Typography>
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                            <strong>Poliester:</strong>  R$ {valor.val2}
                      </Typography>
                      <Typography component="li" variant="subtitle1" align="center" key={id}>
                ...
                <Linkar href={`https://api.whatsapp.com/send?phone=5571991604540&text=${nome} || ${descricao} 
                 ||  Valores: Algodão: R$ ${valor.val1} - Poliester: R$ ${valor.val2} - Especiais: R$ ${valor.val3} !`} 
